...
RightAngledIsoscelesTriangle::RightAngledIsoscelesTriangle(Point src):Polygon_(src){}

void RightAngledIsoscelesTriangle::updateDest(int x, int y)
{
	SObject::updateDest(x, y);
	this->addVertices();
}

void RightAngledIsoscelesTriangle::addVertices()
{
	this->points.clear();
